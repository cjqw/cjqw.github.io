...
的定位它的儿子，因此 vector 的查询复杂度是 O(log~32~(n)) 的。
...
好吧这就是哈夫曼编码。要注意的是，每位信息量尽量大并不等价于编码的期望长度尽量短，
以上的说法只能说 just for
fun。如果哪位大佬证明了上面两个东西是等价的欢迎打脸。。。。
基于信息论的编码方式也是有的，不过好像打不赢哈夫曼编码，大家有兴趣的话自己搜吧。

另外，以信息论的观点看，ASC II
编码效率很低，大半字符基本上用不到。不过这东西好处是方便，
